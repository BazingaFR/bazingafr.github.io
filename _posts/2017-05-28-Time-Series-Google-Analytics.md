...
![](images/GoogleAnalyticsTimeSeriesWithR_files/figure-html/unnamed-chunk-5-1.png?raw=true)<!-- -->
...
![](images/GoogleAnalyticsTimeSeriesWithR_files/figure-html/unnamed-chunk-6-1.png?raw=true)<!-- -->
...
![](images/GoogleAnalyticsTimeSeriesWithR_files/figure-html/unnamed-chunk-7-1.png?raw=true)<!-- -->
...
![](images/GoogleAnalyticsTimeSeriesWithR_files/figure-html/unnamed-chunk-9-1.png?raw=true)<!-- -->
...
![](images/GoogleAnalyticsTimeSeriesWithR_files/figure-html/unnamed-chunk-10-1.png?raw=true)<!-- -->
...
![](images/GoogleAnalyticsTimeSeriesWithR_files/figure-html/unnamed-chunk-11-1.png?raw=true)<!-- -->

```r
hist(fcst$residuals[8:length(fcst$residual)], breaks=10, main="Histogram of Model Residuals")
```

![](images/GoogleAnalyticsTimeSeriesWithR_files/figure-html/unnamed-chunk-11-2.png?raw=true)<!-- -->
